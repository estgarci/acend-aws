# Acend
[https://www.acend.site](www.acend.site) is a live airline web app that communicates with an API which provides users with real-time worldwide flight-traffic data.
***
